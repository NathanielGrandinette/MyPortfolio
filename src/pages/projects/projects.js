    ...
    const events = [
        {
            ...
            image: 'The-N-T-Collection-screenshot.png',
            description: "This project aims to create a modern ecommerce application using ReactJS. Key features include displaying featured products, admin functionalities, and an intuitive cart display. Users can browse products, view details, and add items to the cart. The admin panel allows product and order management. The app will have responsive design, scalability, and optimal performance.",
            skillsUsed: ["React", "Express", "Axios", "Node.js", "MongoDB", "JWT-Tokens"],
            date: "June 2023",
        ...
        },
        {
            ...
            skillsUsed: ["React", "Express", "Axios", "MongoDB", "Node.js", "Oauth2", "JWT-Tokens"],
            date: "March 2023",
